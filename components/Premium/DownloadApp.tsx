...
const DownloadApp = () => {
  return (
    <section className="bg-white text-black">
      <div className="maxContainer sm:px-8 px-5 pt-20">
        <div className="grid sm:items-end sm:grid-cols-[379px_1fr] md:grid-cols-[426px_1fr] lg:grid-cols-[504px_1fr]">
          ...
          <div className="relative sm:w-full ">
            <div className="px-6 py-12 md:px-10 md:py-14 lg:px-20">
              ...
              <p className="mt-4 md:mt-6 max-w-[559px] md:text-[18px] font-poppins lg:text-[22px]">
                ...
                instant payouts, and flexible hours, Kablux is the ride-hailing
                and rider platform that truly works for you.
              </p>
