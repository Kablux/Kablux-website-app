      ...
      >
        ...
        <div className="maxContainer relative px-5 py-24 text-center">
          <motion.h1
            ...
            className="mx-auto max-w-[920px] text-[48px] font-extrabold leading-[0.95] tracking-[-0.04em] text-black md:text-[86px]"
          >
            <span className="block">The Future Of</span>

            <span className="mt-4 block text-[36px] md:text-[64px]">
              Ride Hailing...
