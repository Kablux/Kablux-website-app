      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        >
          <iframe
            ...
            src="https://www.google.com/maps?q=Lekki%20Phase%201%2C%20Lagos&output=embed"
        ...
        >
          ...
          <Button
            className="mt-5 w-full rounded-full bg-[#ffbe18] py-3 text-black sm:w-auto sm:px-10"
          >
            Send A Message
          </Button>
